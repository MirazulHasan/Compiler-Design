...
int main()
{
    ...
    ofstream outputFile("D:/1 AIUB/7th Semester (Spring 2023-24)/COMPILER DESIGN [A] - (NAZMUS SAKIB SHAN)/FINAL TERM - LAB/Lab Task (19 March 2024)/variableName.txt");
    ...
    ifstream inputFile("D:/1 AIUB/7th Semester (Spring 2023-24)/COMPILER DESIGN [A] - (NAZMUS SAKIB SHAN)/FINAL TERM - LAB/Lab Task (19 March 2024)/variableName.txt");
